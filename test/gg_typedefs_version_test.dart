...
void main() {
  group('gg_typedefs_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_typedefs_version.dart');
